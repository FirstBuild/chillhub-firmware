...
Message Examples
1.|Send Device ID (“ChillHub-Demo”)
Byte No|Data|Description||Byte No|Data|Description
0|0x10|Message Length (16 bytes)||9|0x48|H
1|0x01|Message Type (Device ID)||10|0x75|u
2|0x02|Payload Data Type (String)||11|0x62|b
3|0x0C|No of Character in String (13)||12|0x2D|-
4|0x43|C||13|0x44|D
5|0x68|h||14|0x65|e
6|0x69|i||15|0x6D|m
7|0x6C|l||16|0x6F|o
...
2.|Subscribe to Refrigerator Door Status Events
...
3.|Receive Door Status (Freezer Door Open)
Byte No|Data|Description
0|0x03|Message Length (3 bytes)
...
4.|Send Array of Integers (U16) via User-Defined Message 0x71
Byte No|Data|Description||Byte No|Data|Description
0|0x0E|Message Length (14 bytes)||7|0xF2|Array Element #1 = 62040
1|0x71|Message Type (User Defined)||8|0x58|
2|0x01|Payload Data Type (Array)||9|0x21|Array Element #2 = 8531
3|0x05|No of Elements in Array (5)||10|0x53|
4|0x05|Type of Elements in Array (U16)||11|0x11|Array Element #3 = 4458
5|0x04|Array Element #0 = 1059||12|0x6A|
6|0x23|||13|0x00|Array Element #4 = 23
||||14|0x17|

5.|Send JSON Data via User-Defined Message 0xF0
JSON: { name: ‘PIx100’, val: 314 }
The field val is saved as a signed, 16-bit integer
Byte No|Data|Description||Byte No|Data|Description
0|0x17|Message Length ()||12|0x49|I
1|0xF0|Message Type (User Defined)||13|0x78|x
2|0x09|Payload Data Type (JSON)||14|0x31|1
3|0x02|No of Key/Value Pairs in Object (2)||15|0x30|0
4|0x04|No of Characters in Key String (4)||16|0x30|0
5|0x6E|n||17|0x03|No of Characters in Key String (3)
6|0x61|a||18|0x76|v
7|0x6D|m||19|0x61|a
8|0x65|e||20|0x6C|l
9|0x02|Data Type of Value (String)||21|0x06|Data Type of Value (I16)
10|0x06|No of Characters in String (6)||22|0x01|314
11|0x50|P||23|0x3A|
